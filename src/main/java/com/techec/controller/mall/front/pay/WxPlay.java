package com.techec.controller.mall.front.pay;
...
import com.techec.service.mall.user.IUserService;
import com.thoughtworks.xstream.XStream;
import com.thoughtworks.xstream.io.naming.NoNameCoder;
import com.thoughtworks.xstream.io.xml.StaxDriver;
import com.util.CommondUtil;
...
//		wxPlaceOrder.setTotal_fee(totalPrice);
	...
	public static void main(String[] args) {
		System.out.println(new Random().nextInt(800000000) + 100000000);
	}
