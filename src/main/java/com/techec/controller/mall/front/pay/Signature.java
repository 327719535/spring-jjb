...
public static String getSignPay(WxPlaceOrder o){
	String result="appId="+o.getAppid()+"&nonceStr="+o.getNonce_str()+"&package=prepay_id="+o.getPrepay_id()+"&signType=MD5&timeStamp="+o.getTimeStamp();
