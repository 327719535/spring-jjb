package com.techec.service.mall.productcategory;
...
public interface IProductCategoryService extends IBaseService<ProductCategory> {
	 ...
	 * @return 一级子商品种类列表
	 */
    List<ProductCategory> getAllChildCategoryByCategoryId(int categoryId);
	 ...
	 * @return 一级子商品种类列表
	 */
    List<ProductCategory> getAllNormalChildCategoryByCategoryId(int categoryId);
	 ...
	 * @return
	 */
    ProductCategory getParentCategoryByCategoryId(int categoryId);
	 ...
	 * @return
	 */
    List<ProductCategory> getAllFirstLevelCategory();
	/**
	 * 获取所有有效的一级商品分类，只包含已开启的一级子分类
	 * 
	 * @return
	 */
    List<ProductCategory> getAllNormalFirstLevelCategory();
